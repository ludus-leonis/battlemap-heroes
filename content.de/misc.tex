...
\newcommand{\bmhMiscCharacters}{%
	...
	\centering\includegraphics[angle=1,width=1\columnwidth]{\image{bmh/charsheet_fighter.pdf}}

	\newpage

	\centering\includegraphics[angle=1.25,width=1\columnwidth]{\image{bmh/charsheet_cleric.pdf}}

	\vfill

	\centering\includegraphics[angle=-1.5,width=1\columnwidth]{\image{bmh/charsheet_ranger.pdf}}

	\vfill

	\centering\includegraphics[angle=-1,width=1\columnwidth]{\image{bmh/charsheet_thief.pdf}}

	\vfill

	\centering\includegraphics[angle=1.25,width=1\columnwidth]{\image{bmh/charsheet_wizard.pdf}}
