...
\newcommand{\bmhMiscCreditsThanks}{%
	...
	Die folgenden Symbole von \href{http://game-icons.net/}{game-icons.net} finden, leicht modifiziert, unter CC BY 3.0 Verwendung: Spinne von \href{https://twitter.com/unstoppableCarl}{Carl Olsen}; Goblin, Kultist, Ratte, Skelett, Statue und Wiederkehrer von \href{http://lorcblog.blogspot.com/}{Lorc}; Ork und Zombie von \href{http://delapouite.com/}{Delapouite}.
...
\newcommand{\bmhMiscPreparation}{
	...
	\dropping{S}ucht euch einen großen Tisch. Eine Seite ist dem \keyword[*]{Spielleiter} (1) vorbehalten, den wir mit \keyword[*]{SL} abkürzen. Die restlichen \keyword[*]{Spieler} (2) nehmen an den anderen Seiten Platz.
	...
	\noindent
	Der SL zeichnet auf der Battlemap den in der gewählten Mission hervorgehobenen \keyword[*]{Eingangsbereich} (9) ein. Meistens ist das eine Treppe und der erste Raum des Gemäuers. Dann stellt er alle sichtbaren Monster auf.
	...
	\example{Die Spieler nutzen hier aus Pappe ausgeschnittene, beschriftete Scheiben.}
