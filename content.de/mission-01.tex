...
\newcommand{\bmhMissionI}{\fsNormalB\selectfont
	...
	\parchment{
		...
		\trap~Stelle keine Figuren für die zwei Wächterstatuen auf den Plan, sondern zeichne sie nur auf der Karte ein. Sollte ein Held eines der Fallen-Felder betreten, werden die Statuen lebendig und greifen an. (IN\TN2)

		\search~Hier liegt ein geweihter Streitkolben+1 (ST vs. AB). Das heilige Relikt dürfen die Helden nach einer erfolgreichen Mission behalten.
