...
\newcommand{\bmhBestiary}{
	...
	\bmhSubsection{Goblin (I)}
		\emph{Diese kleinen, flinken und fiesen Humanoiden haben grüne, ledrige Haut, spitze Zähne und einen buckeligen Rücken.}

		\bmhList{
			\item[\stats] 2/2, 2/2, 2/1; BEW5, LP1, AP3
			\item[\weapons] rostiges Messer: ST vs. AB
	...
	\bmhSubsection{Wiederkehrer (II)}
		...
		\bmhList{
			...
			\item[\tactics] Solange befreundete Kreaturen anwesend sind, setzen Wiederkehrer ihren Schrei ein, um ihnen einen Vorteil zu verschaffen.
		}
