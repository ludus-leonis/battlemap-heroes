...
\newcommand{\bmhHeroesFighter}{%
...

	{
		...
		\centering\includegraphics[angle=1,width=0.95\columnwidth]{\image{bmh/charsheet_fighter.pdf}}
...
\newcommand{\bmhHeroesRanger}{%
...

	{
		...
		\centering\includegraphics[angle=1,width=0.95\columnwidth]{\image{bmh/charsheet_ranger.pdf}}
	...
	\power{Verdrängungs-Schuss}{2 AP}{
...
\newcommand{\bmhHeroesThief}{%
...

	{
		...
		\centering\includegraphics[angle=-1,width=0.95\columnwidth]{\image{bmh/charsheet_thief.pdf}}
	...
	\power{Sand in die Augen}{2 AP}{
		Attackiere mit \say{GE vs. RE}. Machst du Schaden, wird dein Ziel nicht verletzt, ist aber bist zum Ende deines nächsten Zuges [blind].
	}
...
\newcommand{\bmhHeroesCleric}{%
...

	{
		...
		\centering\includegraphics[angle=-1.25,width=0.95\columnwidth]{\image{bmh/charsheet_cleric.pdf}}
...
\newcommand{\bmhHeroesWizard}{%
...

	{
		...
		\centering\includegraphics[angle=1.02,width=0.95\columnwidth]{\image{bmh/charsheet_wizard.pdf}}
