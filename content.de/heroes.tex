...
\newcommand{\bmhHeroesFighter}{%
	...
	\vspace*{1em}
	{
		...
		\centering\includegraphics[width=0.5\columnwidth]{\image{bmh/portrait-fighter.pdf}}
...

	{
		...
		\centering\includegraphics[angle=1,width=0.95\columnwidth]{\image{bmh/charsheet-fighter.pdf}}
...
\newcommand{\bmhHeroesRanger}{%
	...
	\vspace*{1em}
	{
		...
		\centering\includegraphics[width=0.5\columnwidth]{\image{bmh/portrait-ranger.pdf}}
...

	{
		...
		\centering\includegraphics[angle=1,width=0.95\columnwidth]{\image{bmh/charsheet-ranger.pdf}}
...
\newcommand{\bmhHeroesThief}{%
	...
	\vspace*{1em}
	{
		...
		\centering\includegraphics[width=0.5\columnwidth]{\image{bmh/portrait-thief.pdf}}
...

	{
		...
		\centering\includegraphics[angle=-1,width=0.95\columnwidth]{\image{bmh/charsheet-thief.pdf}}
...
\newcommand{\bmhHeroesCleric}{%
	...
	\vspace*{1em}
	{
		...
		\centering\includegraphics[width=0.5\columnwidth]{\image{bmh/portrait-cleric.pdf}}
...

	{
		...
		\centering\includegraphics[angle=-1.25,width=0.95\columnwidth]{\image{bmh/charsheet-cleric.pdf}}
...
\newcommand{\bmhHeroesWizard}{%
	...
	\vspace*{1em}
	{
		...
		\centering\includegraphics[width=0.5\columnwidth]{\image{bmh/portrait-wizard.pdf}}
...

	{
		...
		\centering\includegraphics[angle=1.02,width=0.95\columnwidth]{\image{bmh/charsheet-wizard.pdf}}
