...
\newcommand{\bmhHeroesFighter}{%
	...
	\vspace*{1em}
	{
		...
		\centering\includegraphics[width=0.5\columnwidth]{\image{bmh/token-fighter.pdf}}
...
\newcommand{\bmhHeroesRanger}{%
	...
	\vspace*{1em}
	{
		...
		\centering\includegraphics[width=0.5\columnwidth]{\image{bmh/token-ranger.pdf}}
...
\newcommand{\bmhHeroesThief}{%
	...
	\vspace*{1em}
	{
		...
		\centering\includegraphics[width=0.5\columnwidth]{\image{bmh/token-thief.pdf}}
...
\newcommand{\bmhHeroesCleric}{%
	...
	\vspace*{1em}
	{
		...
		\centering\includegraphics[width=0.5\columnwidth]{\image{bmh/token-cleric.pdf}}
...
\newcommand{\bmhHeroesWizard}{%
	...
	\vspace*{1em}
	{
		...
		\centering\includegraphics[width=0.5\columnwidth]{\image{bmh/token-wizard.pdf}}
