\newcommand{\bmhMiscVersion}{v0.6-beta}
...
\newcommand{\bmhMiscIntro}{%
	...
	\bmhSection{Was nun?}
		Ihr müsst nicht das ganze Heft lesen, um euere erste Mission zu bestreiten. Schon das Kapitel \say{Basis-Regeln} genügt, um euer erstes Gemäuer zu erkunden.
}
